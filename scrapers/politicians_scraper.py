...
Instagram Scraper
-----------------
Reads a CSV named "politicians_info.csv" with a column "Instagram Tag" (handles without '@').
...
- By default writes to politicians_info_scraped.csv to avoid accidental overwrites.

Usage:
  python insta_playwright_csv.py               # reads politicians_info.csv, writes politicians_info_scraped.csv
...
- If you're starting from a .numbers file, export to CSV first and name it SCRAPING.csv.
"""
...
def main():
    ap = argparse.ArgumentParser(description="Update politicians_info.csv with Instagram follower/post counts.")
    ap.add_argument("--in", dest="in_path", type=Path, default=Path("politicians_info.csv"), help="Input CSV (default: politicians_info.csv)")
    ap.add_argument("--out", dest="out_path", type=Path, default=Path("politicians_info_scraped.csv"), help="Output CSV (default: politicians_info_scraped.csv)")
